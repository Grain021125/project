...
// int64 timestamp = 3;
inline void TextChatData::clear_timestamp() {
  timestamp_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 TextChatData::_internal_timestamp() const {
  return timestamp_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 TextChatData::timestamp() const {
  // @@protoc_insertion_point(field_get:message.TextChatData.timestamp)
  return _internal_timestamp();
}
inline void TextChatData::_internal_set_timestamp(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  timestamp_ = value;
}
inline void TextChatData::set_timestamp(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_timestamp(value);
  // @@protoc_insertion_point(field_set:message.TextChatData.timestamp)
}
